...
- 📊 Scalable architecture with separated services
...
For detailed setup and usage instructions, please refer to the README files in each subdirectory (frontend, backend, ml-service).
